        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav navbar-right">
                    <li role="presentation"><a href="busquedaMuestra.html">Muestras </a></li>
                    <li class="active" role="presentation"><a href="especies.html">Especies </a></li>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAmuk3onNrslpzRdayt2bzUUSsj3bjCFTM&callback=initMap"></script>
    ...
    <div class="modal-dialog modal-lg" role="document" id="modalL">
    ...
    <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"  style="textAlign:center;overflow:scroll;">
    <div class= "row">
    <div class= "col-lg-12 col-md-12 col-sm-12 col-xs-12 " id="divImage" style="textAlign:center;overflow:scroll;">
    <img class="" id="imagenZoom" src="assets/img/WhatsApp Image 2017-12-06 at 8.45.50 PM.jpeg" height="500px">
    </div>
    <div class= "col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <button class="btn btn-default btn-sm pull-left" id="zoomMenos" onclick="zoomMenos()" type="button"> <i class="glyphicon glyphicon-minus"></i></button>
    <button class="btn btn-default btn-sm pull-right" id="zoomMas" type="button" onclick="zoomMas()"> <i class="glyphicon glyphicon-plus"></i></button>
    </div>
    </div>
    </div>
    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
